...
*/
module.exports = function getSineWaves() {
...
SineWaves.prototype.update = function(time) {
  ...
  while (++index < length) {
    // var timeModifier = this.waves[index].timeModifier || 1;
    // this.waves[index].addTime = (this.waves[index].addTime==undefined ? 0 : this.waves[index].addTime) - (timeModifier - 1) * 0.005;
    // console.info(this.waves[index].addTime);
    this.drawWave(time + this.waves[index].addTime, this.waves[index]);
  }
  this.ctx.restore();
